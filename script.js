...
const explorerItems = [
  {
    ...
    setting: "Indoor",
    dog: false,
    description: "Twyford restaurant and Stanlake Park stockist.",
  ...
  {
    name: "The Cantley House",
    category: "food",
    distance: "Wokingham",
    drive: "Wokingham area",
    setting: "Indoor & Outdoor",
    dog: false,
    description: "Wokingham hotel and restaurant listed as a Stanlake Park stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    name: "The Greene Oak",
  ...
  },
  {
    name: "Park Eat & Bar",
    category: "food",
    distance: "University of Reading Campus",
    drive: "Reading area",
    setting: "Indoor & Outdoor",
    dog: false,
    description: "University of Reading food and drink spot listed as a Stanlake Park stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    name: "Faber",
    category: "food",
    distance: "Hammersmith",
    drive: "London",
    setting: "Indoor",
    dog: false,
    description: "London restaurant listed as a Stanlake Park stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    name: "Vanilla Pod",
  ...
  },
  {
    ...
    setting: "Indoor & Outdoor",
    dog: true,
    description: "Surrey pub listed as a Stanlake Park stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor & Outdoor",
    dog: true,
    description: "Surrey pub and restaurant listed as a Stanlake Park stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    name: "Vegivores",
    category: "food",
    distance: "Bournemouth",
    drive: "Dorset",
    setting: "Indoor",
    dog: false,
    description: "Plant based restaurant listed as a Stanlake Park stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    name: "Daisy's in The Park",
    category: "food",
    distance: "Pinner & Radlett",
    drive: "Hertfordshire",
    setting: "Indoor & Outdoor",
    dog: false,
    description: "Cafe and restaurant group listed as a Stanlake Park stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor",
    dog: false,
    description: "Caversham restaurant specialising in regional Indian food and listed as a Stanlake Park stockist.",
  ...
  },
  {
    ...
    setting: "Indoor & Outdoor",
    dog: true,
    description: "Award winning Berkshire brewery and taproom.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor",
    dog: true,
    description: "Reading brewery and taproom with rotating beers.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor",
    dog: true,
    description: "Small batch Wokingham brewery and taproom.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    name: "Loddon Brewery",
    category: "beer",
    distance: "Dunsden Green",
    drive: "Nearby",
    setting: "Indoor & Outdoor",
    dog: true,
    description: "Local brewery close to Reading and Henley.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor",
    dog: true,
    description: "Reading brewery producing small batch beer.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor & Outdoor",
    dog: true,
    description: "Berkshire brewery with taproom and events.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor",
    dog: true,
    description: "Marlow brewery and shop, useful for visitors exploring the Thames Valley.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor",
    dog: false,
    description: "Local flowers and gifts business listed as a Stanlake Park stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    name: "Hamlet",
    ...
    setting: "Indoor",
    dog: false,
    description: "Wokingham stockist with local food, drink and gifts.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    name: "Bray Cured",
    category: "producers",
    distance: "Bray, Maidenhead",
    drive: "Maidenhead area",
    setting: "Indoor",
    dog: false,
    description: "Local producer and stockist known for cured meats and artisan food.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor",
    dog: false,
    description: "Wokingham interiors and lifestyle stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor & Outdoor",
    dog: true,
    description: "Local garden centre, farm shop and Stanlake Park stockist.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    name: "French & Day",
    ...
    setting: "Indoor",
    dog: false,
    description: "Hertfordshire stockist listed by Stanlake Park.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
    ...
    setting: "Indoor",
    dog: false,
    description: "Local cheese producer and supplier, a strong match for wine and food lovers.",
    link: "https://stanlakepark.com/stockists/"
  },
  {
  ...
  },
  {
    ...
    setting: "Indoor & Outdoor",
    dog: true,
    description: "Your nearest village, with rail links, pubs, cafes and local shops.",
  ...
  },
  {
    ...
    setting: "Indoor & Outdoor",
    dog: false,
    description: "Historic house, gardens and Thames views, popular with visitors exploring east Berkshire.",
    link: "https://www.nationaltrust.org.uk/visit/berkshire/cliveden"
  },
  {
  ...
  },
  {
    ...
    setting: "Indoor & Outdoor",
    dog: true,
    description: "National Trust estate with house, parkland and countryside walks.",
    link: "https://www.nationaltrust.org.uk/visit/oxfordshire-buckinghamshire-berkshire/basildon-park"
  },
  {
    name: "Mapledurham Estate",
    category: "heritage",
    distance: "Mapledurham",
    drive: "Day trip",
    setting: "Indoor & Outdoor",
    dog: false,
    description: "Historic estate and Thameside setting near Reading.",
    link: "https://www.mapledurham.co.uk/"
  },
  {
    ...
    setting: "Outdoor",
    dog: false,
    description: "World famous racecourse and a major draw for visitors to Berkshire.",
  ...
  },
  {
    ...
    category: "experiences",
    distance: "Reading and Caversham",
    drive: "Day trip",
    setting: "Outdoor",
    dog: false,
    description: "River cruises from Reading and Caversham, useful for a relaxed day out.",
  ...
  },
  {
    ...
    setting: "Outdoor",
    dog: false,
    description: "World famous rowing event on the Thames, close to our Old School House stay.",
  ...
  },
  {
    ...
    setting: "Outdoor",
    dog: true,
    description: "Large royal parkland with long walks and views towards Windsor Castle.",
    link: "https://www.windsorgreatpark.co.uk/"
  },
  {
...
if (!currentCategory && !search) {
  explorerGrid.innerHTML = `
    <div class="explorer-empty">
      ...
      <p>Find stockists, pubs, breweries, farm shops, local producers, heritage days out and places to visit near Stanlake Park.</p>
    </div>
  `;
  return;
}
